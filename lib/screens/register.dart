            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text("Register",style: TextStyle(fontFamily: 'DM Sans',fontWeight: FontWeight.bold,fontSize: 30.sp,color: primaryColorDark),),
                      SizedBox(height: 20.h,),
                      DefaultTextField(controller: email,text: "Email",),
                      SizedBox(height: 20.h,),
                      DefaultTextField(controller: pass,text: 'Password',),
                      SizedBox(height: 20.h,),
                      DefaultTextField(controller: no,text: "Number",),
                      SizedBox(height: 20.h,),
                      DefaultTextField(controller: cnic,text: "CNIC Number",),
                      SizedBox(height: 20.h,),
                      DefaultTextField(controller: id,text: "Emp ID",),
                      SizedBox(height: 20.h,),
                      Column(
                        children: [
                          DefaultColorButton(text: "Send Code", press: (){
                          }),
