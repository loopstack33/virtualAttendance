        ...
        child: Center(
          child: Column(
            children: [
              ...
              Column(
                children: [
                  const  Text("Welcome",style: TextStyle(fontFamily: 'DM Sans',fontWeight: FontWeight.bold,fontSize: 30,color: primaryColorDark),),
                  const   SizedBox(
                      width: 200,
                      child: Text("Lorem ispum Lorem ispum Lorem ispum Lorem ispum",style: TextStyle(fontFamily: 'DM Sans',fontWeight: FontWeight.w300,fontSize: 16,color: greyShade),)),
